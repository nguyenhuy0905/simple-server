...
all: ${BUILD_DIR}/server ${BUILD_DIR}/client ${BUILD_DIR}/unit_test
...
${BUILD_DIR}/client: ${OBJ_DIR}/client.o ${OBJ_DIR}/printf.o \
	${OBJ_DIR}/strfmt.o
	ld $^ -o $@
...
${OBJ_DIR}/client.o: client.asm io.inc buff.inc network.inc program.inc \
	${OBJ_DIR}
	fasm client.asm $@
